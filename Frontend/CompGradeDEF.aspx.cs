...
{
    public partial class CompGradeDEF : System.Web.UI.Page
    {
        ...
        protected void Button1_Click(object sender, EventArgs e)
        {
            ...
            SqlCommand gradeDef = new SqlCommand("CompanyGradedefense", conn);
            gradeDef.CommandType = System.Data.CommandType.StoredProcedure;
            gradeDef.Parameters.Add(new SqlParameter("@Company_id", cid));
            gradeDef.Parameters.Add(new SqlParameter("@sid", sid));
            gradeDef.Parameters.Add(new SqlParameter("@defense_location", loc));
            gradeDef.Parameters.Add(new SqlParameter("@Company_grade", grade));

            conn.Open();
            gradeDef.ExecuteNonQuery();
            conn.Close();
