...
namespace MileStone3
{
    public partial class Company : System.Web.UI.Page
    {
        ...
        {
            string connStr = WebConfigurationManager.ConnectionStrings["DB_Project"].ToString();
            //create new connection
            SqlConnection conn = new SqlConnection(connStr);
            conn.Open();
            Response.Redirect("Emp_Register.aspx");
            conn.Close();
        }
        ...
        protected void Button2_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            Response.Redirect("Proj_Create.aspx");
            conn.Close();
        ...
        protected void Button4_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            Response.Redirect("CompGradeThesis.aspx");
            conn.Close();
        }
        ...
        protected void Button5_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            Response.Redirect("CompGradeDEF.aspx");
            conn.Close();
        }
        ...
        protected void Button6_Click(object sender, EventArgs e)
        {
            ...
            conn.Open();
            Response.Redirect("GradePR.aspx");
            conn.Close();
        }
