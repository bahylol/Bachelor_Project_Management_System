...
namespace MileStone3
{
    public partial class GradeDefense : System.Web.UI.Page
    {
        ...
        protected void submit_Click(object sender, EventArgs e)
        {
            ...
            SqlParameter eeid = gradedefense.Parameters.Add(new SqlParameter("@EE_id", SqlDbType.Int));
            ...
            SqlParameter g = gradedefense.Parameters.Add(new SqlParameter("@EE_grade", SqlDbType.Decimal, 4));
            g.Value = Decimal.Parse(grade.Text);
            SqlParameter loc = gradedefense.Parameters.Add(new SqlParameter("@defense_location", SqlDbType.VarChar, 5));
