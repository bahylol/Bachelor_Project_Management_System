...
{
    public partial class Reccomendations : System.Web.UI.Page
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            {
                conn.Open();
                SqlCommand recdetails = new SqlCommand("ViewRecommendation", conn);
                recdetails.CommandType = CommandType.StoredProcedure;
                SqlParameter id = recdetails.Parameters.Add(new SqlParameter("@lecture_id", SqlDbType.Int));
                id.Value = DBNull.Value;
                SqlDataAdapter dataAdapter = new SqlDataAdapter(recdetails);
                DataTable data = new DataTable();
                dataAdapter.Fill(data);
                RecList.DataSource = data;
                RecList.DataBind();
            }
        ...
        protected void ChooseRecLec_SelectedIndexChanged(object sender, EventArgs e)
        {
        ...
        protected void Go_Click(object sender, EventArgs e)
        {
            ...
            using (conn)
            {
                ...
                recdetails.CommandType = CommandType.StoredProcedure;
                SqlParameter id = recdetails.Parameters.Add(new SqlParameter("@lecture_id", SqlDbType.Int));
                id.Value = ChooseRecLec.SelectedItem.Value;
                SqlDataAdapter dataAdapter = new SqlDataAdapter(recdetails);
                DataTable data = new DataTable();
                dataAdapter.Fill(data);
                RecList.DataSource = data;
